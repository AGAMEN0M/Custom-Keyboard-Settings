...
namespace InputSystemExtension.Editor
{
    ...
    public class InputDisplayManagerInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(new GUIContent("Create Automatic Presets", "Automatically generates UI images based on Input Actions."), GUILayout.Height(30)))
            {
