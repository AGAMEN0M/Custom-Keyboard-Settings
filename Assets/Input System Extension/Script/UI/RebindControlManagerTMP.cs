...
{
    [AddComponentMenu("Tools/Input System Extension/UI/Rebind/Rebind Control Manager (TMP)")]
    public class RebindControlManagerTMP : MonoBehaviour
    {
        ...
        private TMP_Text bindingDisplayText;
        ...
        private TMP_Text rebindPromptText;
