...
{
    [AddComponentMenu("Tools/Input System Extension/UI/Rebind/Legacy/Rebind Control Manager (Legacy)")]
    public class RebindControlManager : MonoBehaviour
    {
        ...
        private InputActionReference cancelRebindActionReference;
        ...
        private static List<RebindControlManager> allRebindManagers; // Static list of all active rebind managers for centralized updates.
        ...
        private void OnEnable()
        {
            ...
            allRebindManagers ??= new List<RebindControlManager>();
        ...
        public void RefreshBindingDisplay()
        {
            ...
            if (bindingDisplayText != null) bindingDisplayText.text = bindingDisplay;

            // Enable or disable the reset button based on modification state.
            if (resetButton != null) resetButton.interactable = isModified;
        ...
        private void ExecuteInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            void CleanUp()
            {
                ...
                if (currentEventSystem != null) currentEventSystem.gameObject.SetActive(true);
            ...
            if (rebindOverlayUI != null) rebindOverlayUI.SetActive(true);
        ...
        /// </summary>
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<RebindControlManager, string, string, string> { }

        /// <summary>
        /// Event triggered when a rebind operation starts or ends.
        /// </summary>
        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<RebindControlManager, InputActionRebindingExtensions.RebindingOperation> { }
